...
type ContT<'Mr,'A> with
    ...
    static member Apply  (_:Apply , f, x, _:ContT<'mr,'b>) = fun () -> ContT.apply f x :ContT<'mr,'b>
    ...
    static member Ask   (_:Ask, _:ContT<Reader<'a,'b>,'a>) = fun () -> Lift.Invoke (Reader.ask())  :ContT<Reader<'a,'b>,'a>
    ...
    static member Get (_:Get, _:ContT<State<'s,'a>,'s>  ) = fun () -> Lift.Invoke (State.get()):ContT<State<'s,'a>,'s>
