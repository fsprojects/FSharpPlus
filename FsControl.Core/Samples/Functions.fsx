...
// FsControl does not export any function, just the 'Type Methods'.
// You can define your own generic functions, this script should give you an idea how to do it.
// The following code was taken from F#+ (https://github.com/gmpl/FSharpPlus)
