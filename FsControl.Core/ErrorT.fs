...
type ErrorT<'R> with
    ...
    static member        Ask   (_: ErrorT<Reader<'a,Choice<'a,'b>>>) = (ErrorT << (liftM Choice1Of2)) (Reader.ask()) : ErrorT<Reader<'a,Choice<'a,'b>>>
    ...
    static member inline Listen (m, _:ErrorT<_> ) = fun () ->
