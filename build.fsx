...
let summary = "F#+ is a library with extensions for F# based on FsControl."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "F#+ is a library with extensions for F# based on FsControl."
...
let gitOwner = "Gusty"
let gitHome = sprintf "%s/%s" "https://github.com/FSharpPlus" gitOwner

// The name of the project on GitHub
let gitName = "FSharpPlus"

// The url for the raw files hosted
let gitRaw = environVarOrDefault "gitRaw" "https://raw.github.com/FSharpPlus"
