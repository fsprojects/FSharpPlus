...
module NonEmptyList =
    ...
    let inline average (list: NonEmptyList<'T>) = Seq.average list
    ...
    let inline concat (lists: NonEmptyList<NonEmptyList<'T>>) = lists |> Seq.concat |> ofSeq
    ...
    let inline tryConcat (lists: NonEmptyList<#seq<'T>>) = lists |> Seq.concat |> tryOfSeq
    ...
    let inline contains (value: 'T) (list: NonEmptyList<'T>) = Seq.contains value list
    ...
    let inline countBy (projection: 'T -> 'U) (list: NonEmptyList<'T>) = Seq.countBy projection list
    ...
    let inline exactlyOne (list: NonEmptyList<'T>) = Seq.exactlyOne list
    ...
    let inline except (itemsToExclude: #seq<'T>) (list: NonEmptyList<'T>) = Seq.except itemsToExclude list |> ofSeq
    ...
    let inline exists (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.exists predicate list
    ...
    let inline find (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.find predicate list
    ...
    /// <returns>The first element that satisfies the predicate.</returns>
    /// <exception cref="KeyNotFoundException">Thrown if the predicate evaluates to false for all the elements of the list.</exception>
    let inline findBack (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.findBack predicate list
    ...
    /// <returns>The first element that satisfies the predicate.</returns>
    /// <exception cref="KeyNotFoundException">Thrown if the predicate evaluates to false for all the elements of the list.</exception>
    let inline findIndex (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.findIndex predicate list
    ...
    /// <returns>The first element that satisfies the predicate.</returns>
    /// <exception cref="KeyNotFoundException">Thrown if the predicate evaluates to false for all the elements of the list.</exception>
    let inline findIndexBack (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.findIndexBack predicate list
    ...
    let inline fold (folder: 'State -> 'T -> 'State) (state: 'State) (list: NonEmptyList<'T>) = Seq.fold folder state list
    ...
    /// <param name="state">The initial state.</param>
    /// <returns>The final state value.</returns>
    let inline foldBack (folder: 'T -> 'State -> 'State) (list: NonEmptyList<'T>) (state: 'State) = Seq.foldBack folder list state
    ...
    let inline forall (predicate: 'T -> bool) (list: NonEmptyList<'T>) = Seq.forall predicate list
    ...
    let inline forall2 (predicate: 'T1 -> 'T2 -> bool) (list1: NonEmptyList<'T1>) (list2: NonEmptyList<'T2>) = Seq.forall2 predicate list1 list2
    ...
    let reduce (reduction: 'T -> 'T -> 'T)  (list: NonEmptyList<'T>) = List.reduce reduction (list.Head :: list.Tail)
    ...
    let reduceBack (reduction: 'T -> 'T -> 'T)  (list: NonEmptyList<'T>) = List.reduceBack reduction (list.Head :: list.Tail)
