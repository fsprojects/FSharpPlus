...
type Lift2 with
    ...
    static member inline Lift2 (_: 'a, (_:'t when 't: null and 't: struct, _: ^u when ^u : null and ^u: struct), _mthd: Default1) = id: 'b -> 'b
...
type Lift3 with
    ...
    static member inline Lift3 (_: 'a, (_:'t when 't: null and 't: struct, _: ^u when ^u : null and ^u: struct, _: ^v when ^v : null and ^v: struct), _mthd: Default1) = id: 'b -> 'b
