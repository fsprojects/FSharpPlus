...
# (export TargetPath=src/FSharpPlus/bin/Release/net462/FSharpPlus.dll ;dotnet fsdocs build --projects src/FSharpPlus/FSharpPlus.fsproj --input docsrc/content/ --output docs/)
