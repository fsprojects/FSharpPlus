...
type ListT with
    ...
    static member get_Get() = lift State.get :  ListT<State<'S,_>>  
    static member Put (x:'T) = x |> State.put |> lift :  ListT<_>  
    
    static member get_Ask() = lift Reader.ask :  ListT<Reader<'R,  list<'R>>>
